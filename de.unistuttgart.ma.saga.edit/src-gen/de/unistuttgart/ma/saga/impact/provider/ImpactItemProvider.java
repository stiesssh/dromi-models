...
public class ImpactItemProvider 
	...
	protected void addRootCausePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Impact_rootCause_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Impact_rootCause_feature", "_UI_Impact_type"),
				 ImpactPackage.Literals.IMPACT__ROOT_CAUSE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ImpactPackage.Literals.IMPACT__CAUSE);
			childrenFeatures.add(ImpactPackage.Literals.IMPACT__ROOT_CAUSE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ImpactPackage.Literals.IMPACT__ROOT_CAUSE,
				 SloFactory.eINSTANCE.createViolation()));
	}
