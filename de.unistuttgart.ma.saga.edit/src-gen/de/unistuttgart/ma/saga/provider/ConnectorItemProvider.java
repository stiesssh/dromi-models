...
/**
 * This is the item provider adapter for a {@link de.unistuttgart.ma.saga.Connector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connector_componentinterface_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connector_componentinterface_feature", "_UI_Connector_type"),
				 SagaPackage.Literals.CONNECTOR__COMPONENTINTERFACE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTaskPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connector_task_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connector_task_feature", "_UI_Connector_type"),
				 SagaPackage.Literals.CONNECTOR__TASK,
				 true,
				 false,
				 true,
				 null,
