...
public class BackendImporter {
	...
	public Impact parseImpact(String xml) {
		...
		ResourceSet set = new ResourceSetImpl();
		Resource resource = set
				.getResource(org.eclipse.emf.common.util.URI.createPlatformResourceURI("foo.impact", false), false);
		if (resource == null) {
			resource = set
					.createResource(org.eclipse.emf.common.util.URI.createPlatformResourceURI("foo.impact", false));
		}
