...
public class GropiusSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case GropiusPackage.COMPONENT: {
			...
			if (result == null)
				result = caseIssueLocation(component);
			if (result == null)
				result = caseNode(component);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case GropiusPackage.COMPONENT_INTERFACE: {
			...
			if (result == null)
				result = caseIssueLocation(componentInterface);
			if (result == null)
				result = caseNode(componentInterface);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case GropiusPackage.ISSUE: {
			...
			if (result == null)
				result = caseComment(issue);
			if (result == null)
				result = caseNode(issue);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case GropiusPackage.ISSUE_TIMELINE_ITEM: {
			...
			if (result == null)
				result = caseNode(issueTimelineItem);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
