...
public class GropiusPackageImpl extends EPackageImpl implements GropiusPackage {
	...
	public static GropiusPackage init() {
		if (isInited)
			return (GropiusPackage) EPackage.Registry.INSTANCE.getEPackage(GropiusPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredGropiusPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		GropiusPackageImpl theGropiusPackage = registeredGropiusPackage instanceof GropiusPackageImpl
				? (GropiusPackageImpl) registeredGropiusPackage
				: new GropiusPackageImpl();
	...
	public void initializePackageContents() {
		...
		initEAttribute(getNode_Id(), this.getID(), "id", null, 0, 1, Node.class, !IS_TRANSIENT, !IS_VOLATILE,
		...
		initEReference(getComponent_Owner(), this.getUser(), null, "owner", null, 0, 1, Component.class, !IS_TRANSIENT,
		...
		initEReference(getComponent_Projects(), this.getProject(), null, "projects", null, 0, -1, Component.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getComponent_Interfaces(), this.getComponentInterface(), this.getComponentInterface_Component(),
				"interfaces", null, 0, -1, Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getComponent_ConsumedInterfaces(), this.getComponentInterface(),
				this.getComponentInterface_ConsumedBy(), "consumedInterfaces", null, 0, -1, Component.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(imsEClass, de.unistuttgart.gropius.IMS.class, "IMS", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getIMS_ImsType(), this.getIMSType(), "imsType", null, 0, 1, de.unistuttgart.gropius.IMS.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getIMS_Component(), this.getComponent(), null, "component", null, 0, 1,
				de.unistuttgart.gropius.IMS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(componentInterfaceEClass, ComponentInterface.class, "ComponentInterface", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getComponentInterface_Component(), this.getComponent(), this.getComponent_Interfaces(),
				"component", null, 1, 1, ComponentInterface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getComponentInterface_ConsumedBy(), this.getComponent(), this.getComponent_ConsumedInterfaces(),
				"consumedBy", null, 0, -1, ComponentInterface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(issueEClass, Issue.class, "Issue", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getIssue_UpdatedAt(), this.getDate(), "updatedAt", null, 0, 1, Issue.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIssue_IsOpen(), ecorePackage.getEBoolean(), "isOpen", null, 0, 1, Issue.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIssue_IsDuplicate(), ecorePackage.getEBoolean(), "isDuplicate", null, 0, 1, Issue.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIssue_Category(), this.getIssueCategory(), "category", null, 0, 1, Issue.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIssue_CurrentUserCanComment(), ecorePackage.getEBoolean(), "currentUserCanComment", null, 0,
				1, Issue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getIssue_StartDate(), this.getDate(), "startDate", null, 0, 1, Issue.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIssue_DueDate(), this.getDate(), "dueDate", null, 0, 1, Issue.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIssue_EstimatedTime(), this.getTimeSpan(), "estimatedTime", null, 0, 1, Issue.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(issueTimelineItemEClass, IssueTimelineItem.class, "IssueTimelineItem", IS_ABSTRACT, IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getIssueTimelineItem_Issue(), this.getIssue(), null, "issue", null, 0, 1,
				IssueTimelineItem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getIssueTimelineItem_CreatedBy(), this.getUser(), null, "createdBy", null, 0, 1,
				IssueTimelineItem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getIssueTimelineItem_CreatedAt(), this.getDate(), "createdAt", null, 0, 1,
				IssueTimelineItem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(issueLocationEClass, IssueLocation.class, "IssueLocation", IS_ABSTRACT, IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getIssueLocation_Name(), ecorePackage.getEString(), "name", null, 0, 1, IssueLocation.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
