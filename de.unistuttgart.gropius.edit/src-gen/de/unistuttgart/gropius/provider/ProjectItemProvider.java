...
/**
 * This is the item provider adapter for a {@link de.unistuttgart.gropius.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						GropiusPackage.Literals.PROJECT__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Project_description_feature",
								"_UI_Project_type"),
						GropiusPackage.Literals.PROJECT__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addComponentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Project_components_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Project_components_feature",
								"_UI_Project_type"),
						GropiusPackage.Literals.PROJECT__COMPONENTS, true, false, true, null, null, null));
	}
	...
	protected void addUsersPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Project_users_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Project_users_feature",
								"_UI_Project_type"),
						GropiusPackage.Literals.PROJECT__USERS, true, false, true, null, null, null));
	}
	...
	protected void addOwnerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Project_owner_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Project_owner_feature",
								"_UI_Project_type"),
						GropiusPackage.Literals.PROJECT__OWNER, true, false, true, null, null, null));
	}
	...
	protected void addIssuesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Project_issues_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Project_issues_feature",
								"_UI_Project_type"),
						GropiusPackage.Literals.PROJECT__ISSUES, true, false, true, null, null, null));
	}
	...
	protected void addLabelsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Project_labels_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Project_labels_feature",
								"_UI_Project_type"),
						GropiusPackage.Literals.PROJECT__LABELS, true, false, true, null, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(GropiusPackage.Literals.PROJECT__COMPONENTS,
				GropiusFactory.eINSTANCE.createComponent()));

		newChildDescriptors.add(
				createChildParameter(GropiusPackage.Literals.PROJECT__ISSUES, GropiusFactory.eINSTANCE.createIssue()));

		newChildDescriptors.add(
				createChildParameter(GropiusPackage.Literals.PROJECT__LABELS, GropiusFactory.eINSTANCE.createLabel()));
	}
