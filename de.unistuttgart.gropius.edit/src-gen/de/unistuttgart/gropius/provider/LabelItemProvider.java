...
/**
 * This is the item provider adapter for a {@link de.unistuttgart.gropius.Label} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LabelItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						GropiusPackage.Literals.LABEL__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Label_description_feature",
								"_UI_Label_type"),
						GropiusPackage.Literals.LABEL__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Label_color_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Label_color_feature", "_UI_Label_type"),
						GropiusPackage.Literals.LABEL__COLOR, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addComponentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Label_components_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Label_components_feature",
								"_UI_Label_type"),
						GropiusPackage.Literals.LABEL__COMPONENTS, true, false, true, null, null, null));
	}
	...
	protected void addProjectsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Label_projects_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Label_projects_feature", "_UI_Label_type"),
						GropiusPackage.Literals.LABEL__PROJECTS, true, false, true, null, null, null));
	}
