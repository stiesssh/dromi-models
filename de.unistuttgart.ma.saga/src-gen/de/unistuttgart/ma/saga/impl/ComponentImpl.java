 ...
 * </p>
 * <ul>
 *   <li>{@link de.unistuttgart.ma.saga.impl.ComponentImpl#getInterfaces <em>Interfaces</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentImpl extends ElementWithSLOImpl implements Component {
	/**
	...
	protected EClass eStaticClass() {
		return SagaPackage.Literals.COMPONENT;
	}
	...
	public EList<ComponentInterface> getInterfaces() {
		if (interfaces == null) {
			interfaces = new EObjectContainmentEList<ComponentInterface>(ComponentInterface.class, this,
					SagaPackage.COMPONENT__INTERFACES);
		}
		return interfaces;
	}
