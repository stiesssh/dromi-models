...
public class ProjectImpl extends MinimalEObjectImpl.Container implements Project {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GropiusPackage.PROJECT__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<User> getUsers() {
		if (users == null) {
			users = new EObjectWithInverseResolvingEList.ManyInverse<User>(User.class, this, GropiusPackage.PROJECT__USERS, GropiusPackage.USER__PROJECTS);
		}
		return users;
	}
