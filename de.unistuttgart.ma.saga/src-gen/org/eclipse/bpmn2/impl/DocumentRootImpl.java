...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
    ...
    public BaseElement getBaseElementWithMixedContent() {
		return (BaseElement)getMixed().get(Bpmn2Package.eINSTANCE.getDocumentRoot_BaseElementWithMixedContent(), true);
	}
    ...
    public ExtensionAttributeValue getExtensionElements() {
		return (ExtensionAttributeValue)getMixed().get(Bpmn2Package.eINSTANCE.getDocumentRoot_ExtensionElements(), true);
	}
    ...
    public EObject getScript() {
		return (EObject)getMixed().get(Bpmn2Package.eINSTANCE.getDocumentRoot_Script(), true);
	}
    ...
    public EObject getText() {
		return (EObject)getMixed().get(Bpmn2Package.eINSTANCE.getDocumentRoot_Text(), true);
	}
