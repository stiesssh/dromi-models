/**
 */
package de.unistuttgart.gropius.slo.util;
...
public class SloAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected SloSwitch<Adapter> modelSwitch = new SloSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.unistuttgart.gropius.slo.SloRule <em>Rule</em>}'.
	 * <!-- begin-user-doc -->
