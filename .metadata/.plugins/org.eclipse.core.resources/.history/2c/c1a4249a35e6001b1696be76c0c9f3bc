...
import org.eclipse.bpmn2.di.provider.DiagramItemProvider;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.dd.di.BPMNDiagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BPMNDiagramItemProvider extends DiagramItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiPackage.Literals.BPMN_DIAGRAM__PLANE);
			childrenFeatures.add(DiPackage.Literals.BPMN_DIAGRAM__LABEL_STYLE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DiPackage.Literals.BPMN_DIAGRAM__PLANE,
				 DiFactory.eINSTANCE.createBPMNPlane()));

		newChildDescriptors.add
			(createChildParameter
				(DiPackage.Literals.BPMN_DIAGRAM__LABEL_STYLE,
