 ...
 *   <li>{@link org.eclipse.bpmn2.di.DiagramElement#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @see org.eclipse.bpmn2.di.BpmnDiPackage#getDiagramElement()
 * @model extendedMetaData="name='DiagramElement' kind='elementOnly'"
 * @generated
 */
public interface DiagramElement extends EObject {
	 ...
	 * @see org.eclipse.bpmn2.di.BpmnDiPackage#getDiagramElement_AnyAttribute()
