...
public class ComponentImpl extends MinimalEObjectImpl.Container implements Component {
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GropiusPackage.COMPONENT__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<Issue> getIssueOnLocation() {
		if (issueOnLocation == null) {
			issueOnLocation = new EObjectResolvingEList<Issue>(Issue.class, this, GropiusPackage.COMPONENT__ISSUE_ON_LOCATION);
		}
	...
	public User getOwner() {
		if (owner != null && owner.eIsProxy()) {
			...
			if (owner != oldOwner) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GropiusPackage.COMPONENT__OWNER, oldOwner, owner));
			}
		}
		return owner;
	}
	...
	public IMS getIms() {
		if (ims != null && ims.eIsProxy()) {
			...
			if (ims != oldIms) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GropiusPackage.COMPONENT__IMS, oldIms, ims));
			}
		}
		return ims;
	}
	...
	public EList<ComponentInterface> getConsumedInterfaces() {
		if (consumedInterfaces == null) {
			consumedInterfaces = new EObjectResolvingEList<ComponentInterface>(ComponentInterface.class, this, GropiusPackage.COMPONENT__CONSUMED_INTERFACES);
		}
	...
	public EList<Label> getLabels() {
		if (labels == null) {
			labels = new EObjectWithInverseResolvingEList.ManyInverse<Label>(Label.class, this, GropiusPackage.COMPONENT__LABELS, GropiusPackage.LABEL__COMPONENTS);
		}
		return labels;
	}
