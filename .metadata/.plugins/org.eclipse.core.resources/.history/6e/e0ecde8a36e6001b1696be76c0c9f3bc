...
public interface DiPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int BPMN_DIAGRAM_OPERATION_COUNT = BpmnDiPackage.DIAGRAM_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int BPMN_EDGE__ANY_ATTRIBUTE = BpmnDiPackage.LABELED_EDGE__ANY_ATTRIBUTE;
	 ...
	 * @ordered
	 */
	int BPMN_EDGE_OPERATION_COUNT = BpmnDiPackage.LABELED_EDGE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int BPMN_LABEL__ANY_ATTRIBUTE = BpmnDiPackage.LABEL__ANY_ATTRIBUTE;
	 ...
	 * @ordered
	 */
	int BPMN_LABEL_OPERATION_COUNT = BpmnDiPackage.LABEL_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int BPMN_LABEL_STYLE_OPERATION_COUNT = BpmnDiPackage.STYLE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int BPMN_PLANE__ANY_ATTRIBUTE = BpmnDiPackage.PLANE__ANY_ATTRIBUTE;
	 ...
	 * @ordered
	 */
	int BPMN_PLANE___PLANE_ELEMENT_TYPE__DIAGNOSTICCHAIN_MAP = BpmnDiPackage.PLANE___PLANE_ELEMENT_TYPE__DIAGNOSTICCHAIN_MAP;
	 ...
	 * @ordered
	 */
	int BPMN_PLANE_OPERATION_COUNT = BpmnDiPackage.PLANE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int BPMN_SHAPE__ANY_ATTRIBUTE = BpmnDiPackage.LABELED_SHAPE__ANY_ATTRIBUTE;
	 ...
	 * @ordered
	 */
	int BPMN_SHAPE_OPERATION_COUNT = BpmnDiPackage.LABELED_SHAPE_OPERATION_COUNT + 0;
