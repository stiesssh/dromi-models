...
public class IssueCommentImpl extends MinimalEObjectImpl.Container implements IssueComment {
	...
	public void setBodyRendered(String newBodyRendered) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GropiusPackage.ISSUE_COMMENT__BODY_RENDERED, oldBodyRendered, bodyRendered));
	}
	...
	public User getCommentCreatedBy() {
		if (commentCreatedBy != null && commentCreatedBy.eIsProxy()) {
			...
			if (commentCreatedBy != oldCommentCreatedBy) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GropiusPackage.ISSUE_COMMENT__COMMENT_CREATED_BY, oldCommentCreatedBy, commentCreatedBy));
			}
		}
	...
	public void setCommentCreatedBy(User newCommentCreatedBy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GropiusPackage.ISSUE_COMMENT__COMMENT_CREATED_BY, oldCommentCreatedBy, commentCreatedBy));
	}
	...
	public void setCommentCreatedAt(Object newCommentCreatedAt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GropiusPackage.ISSUE_COMMENT__COMMENT_CREATED_AT, oldCommentCreatedAt, commentCreatedAt));
	}
	...
	public void setLastEditedAt(Object newLastEditedAt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GropiusPackage.ISSUE_COMMENT__LAST_EDITED_AT, oldLastEditedAt, lastEditedAt));
	}
	...
	public void setCurrentUserCanEdit(boolean newCurrentUserCanEdit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GropiusPackage.ISSUE_COMMENT__CURRENT_USER_CAN_EDIT, oldCurrentUserCanEdit, currentUserCanEdit));
	}
	...
	public EList<ReactionGroup> getReactions() {
		if (reactions == null) {
			reactions = new EObjectResolvingEList<ReactionGroup>(ReactionGroup.class, this, GropiusPackage.ISSUE_COMMENT__REACTIONS);
		}
		return reactions;
	}
	...
	public Issue getIssue() {
		if (issue != null && issue.eIsProxy()) {
			...
			if (issue != oldIssue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GropiusPackage.ISSUE_COMMENT__ISSUE, oldIssue, issue));
			}
		}
		return issue;
	}
	...
	public void setIssue(Issue newIssue) {
		...
		issue = newIssue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GropiusPackage.ISSUE_COMMENT__ISSUE, oldIssue, issue));
	}
	...
	public User getCreatedBy() {
		if (createdBy != null && createdBy.eIsProxy()) {
			...
			if (createdBy != oldCreatedBy) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GropiusPackage.ISSUE_COMMENT__CREATED_BY, oldCreatedBy, createdBy));
			}
		}
		return createdBy;
	}
	...
	public void setCreatedBy(User newCreatedBy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GropiusPackage.ISSUE_COMMENT__CREATED_BY, oldCreatedBy, createdBy));
	}
	...
	public void setCreatedAt(Object newCreatedAt) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GropiusPackage.ISSUE_COMMENT__CREATED_AT, oldCreatedAt, createdAt));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == IssueTimelineItem.class) {
			switch (derivedFeatureID) {
				case GropiusPackage.ISSUE_COMMENT__ISSUE: return GropiusPackage.ISSUE_TIMELINE_ITEM__ISSUE;
				case GropiusPackage.ISSUE_COMMENT__CREATED_BY: return GropiusPackage.ISSUE_TIMELINE_ITEM__CREATED_BY;
				case GropiusPackage.ISSUE_COMMENT__CREATED_AT: return GropiusPackage.ISSUE_TIMELINE_ITEM__CREATED_AT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IssueTimelineItem.class) {
			switch (baseFeatureID) {
				case GropiusPackage.ISSUE_TIMELINE_ITEM__ISSUE: return GropiusPackage.ISSUE_COMMENT__ISSUE;
				case GropiusPackage.ISSUE_TIMELINE_ITEM__CREATED_BY: return GropiusPackage.ISSUE_COMMENT__CREATED_BY;
				case GropiusPackage.ISSUE_TIMELINE_ITEM__CREATED_AT: return GropiusPackage.ISSUE_COMMENT__CREATED_AT;
				default: return -1;
			}
		}
