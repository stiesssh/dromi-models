...
/**
 * This is the item provider adapter for a {@link gropius.slo.Alert} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SloPackage.Literals.ALERT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addGropiusComponentIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Alert_gropiusComponentId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Alert_gropiusComponentId_feature", "_UI_Alert_type"),
				 SloPackage.Literals.ALERT__GROPIUS_COMPONENT_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addGropiusProjectIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Alert_gropiusProjectId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Alert_gropiusProjectId_feature", "_UI_Alert_type"),
				 SloPackage.Literals.ALERT__GROPIUS_PROJECT_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addGropiusComponentInterfaceIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Alert_gropiusComponentInterfaceId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Alert_gropiusComponentInterfaceId_feature", "_UI_Alert_type"),
				 SloPackage.Literals.ALERT__GROPIUS_COMPONENT_INTERFACE_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
