...
public interface BpmnDiPackage extends EPackage {
	...
	EAttribute getDiagramElement_Id();
				...
				/**
	 * Returns the meta object for the attribute list '{@link org.eclipse.bpmn2.di.DiagramElement#getAnyAttribute <em>Any Attribute</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute list '<em>Any Attribute</em>'.
	 * @see org.eclipse.bpmn2.di.DiagramElement#getAnyAttribute()
	 * @see #getDiagramElement()
	 * @generated
	 */
	...
	EReference getPlane_PlaneElement();
				...
				/**
	 * Returns the meta object for the '{@link org.eclipse.bpmn2.di.Plane#plane_element_type(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Plane element type</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Plane element type</em>' operation.
	 * @see org.eclipse.bpmn2.di.Plane#plane_element_type(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 * @generated
	 */
