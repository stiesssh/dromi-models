 ...
 * </p>
 * <ul>
 *   <li>{@link gropius.slo.impl.ModelImpl#getModelelement <em>Modelelement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
	...
	protected EClass eStaticClass() {
		return SloPackage.Literals.MODEL;
	}
	...
	public EList<ModelElement> getModelelement() {
		if (modelelement == null) {
			modelelement = new EObjectContainmentEList<ModelElement>(ModelElement.class, this, SloPackage.MODEL__MODELELEMENT);
		}
		return modelelement;
	}
