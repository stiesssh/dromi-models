...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn2.di.DiagramElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramElementItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BpmnDiPackage.Literals.DIAGRAM_ELEMENT__ANY_ATTRIBUTE);
		}
