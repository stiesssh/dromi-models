...
public class Bpmn2OppositeReferenceAdapter extends ECrossReferenceAdapter {
    ...
    static {
        ...
        DEFAULT_OBSERVED_REFERENCES.put(Bpmn2Package.eINSTANCE.getFlowElement_CategoryValueRef(),
                Bpmn2Package.eINSTANCE.getCategoryValue_CategorizedFlowElements());
        DEFAULT_OBSERVED_REFERENCES.put(Bpmn2Package.eINSTANCE.getConversationLink_SourceRef(),
                Bpmn2Package.eINSTANCE.getInteractionNode_OutgoingConversationLinks());
        DEFAULT_OBSERVED_REFERENCES.put(Bpmn2Package.eINSTANCE.getConversationLink_TargetRef(),
     ...
     */
    public <E> EList<E> getOppositeList(Class<E> dataClass, InternalEObject owner,
        ...
        EList<E> result = new BasicInternalEList<E>(dataClass);
