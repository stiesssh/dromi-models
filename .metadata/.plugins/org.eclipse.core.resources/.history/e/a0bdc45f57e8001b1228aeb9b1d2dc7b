...
public class ComponentInterfaceImpl extends MinimalEObjectImpl.Container implements ComponentInterface {
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GropiusPackage.COMPONENT_INTERFACE__NAME, oldName, name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GropiusPackage.COMPONENT_INTERFACE__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<Issue> getIssueOnLocation() {
		if (issueOnLocation == null) {
			issueOnLocation = new EObjectResolvingEList<Issue>(Issue.class, this, GropiusPackage.COMPONENT_INTERFACE__ISSUE_ON_LOCATION);
		}
	...
	public Component getComponent() {
		if (component != null && component.eIsProxy()) {
			...
			if (component != oldComponent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GropiusPackage.COMPONENT_INTERFACE__COMPONENT, oldComponent, component));
			}
		}
		return component;
	}
	...
	public void setComponent(Component newComponent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GropiusPackage.COMPONENT_INTERFACE__COMPONENT, oldComponent, component));
	}
	...
	public EList<Component> getConsumedBy() {
		if (consumedBy == null) {
			consumedBy = new EObjectResolvingEList<Component>(Component.class, this, GropiusPackage.COMPONENT_INTERFACE__CONSUMED_BY);
		}
		return consumedBy;
	}
