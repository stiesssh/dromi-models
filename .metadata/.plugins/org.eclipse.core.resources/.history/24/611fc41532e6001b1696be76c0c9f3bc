		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GropiusPackage.Literals.USER__USERNAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_User_displayname_feature", "_UI_User_type"),
				 GropiusPackage.Literals.USER__DISPLAYNAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GropiusPackage.Literals.USER__EMAIL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAssignedToIssuesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_User_assignedToIssues_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_User_assignedToIssues_feature", "_UI_User_type"),
				 GropiusPackage.Literals.USER__ASSIGNED_TO_ISSUES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addParticipantOfIssuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_User_participantOfIssue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_User_participantOfIssue_feature", "_UI_User_type"),
				 GropiusPackage.Literals.USER__PARTICIPANT_OF_ISSUE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIssueCommentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_User_issueComments_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_User_issueComments_feature", "_UI_User_type"),
				 GropiusPackage.Literals.USER__ISSUE_COMMENTS,
				 true,
				 false,
				 true,
				 null,
