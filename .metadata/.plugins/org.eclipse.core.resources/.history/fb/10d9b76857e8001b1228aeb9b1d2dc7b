...
public class DiPackageImpl extends EPackageImpl implements DiPackage {
    ...
    public void initializePackageContents() {
		...
		BpmnDiPackage theDiPackage_1 = (BpmnDiPackage)EPackage.Registry.INSTANCE.getEPackage(BpmnDiPackage.eNS_URI);
		...
		initEReference(getBPMNEdge_SourceElement(), theDiPackage_1.getDiagramElement(), null, "sourceElement", null, 0, 1, BPMNEdge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getBPMNEdge_TargetElement(), theDiPackage_1.getDiagramElement(), null, "targetElement", null, 0, 1, BPMNEdge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
