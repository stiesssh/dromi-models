 ...
 * @generated
 */
public class ChainLinkItemProvider extends IdentifiableElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ChainLinkItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ChainLink)object).getName();
