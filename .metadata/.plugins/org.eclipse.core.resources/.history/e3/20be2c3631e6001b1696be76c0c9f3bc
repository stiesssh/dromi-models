 ...
 * @generated
 */
public class IssueCommentItemProvider 
	...
	protected void addIssuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IssueTimelineItem_issue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IssueTimelineItem_issue_feature", "_UI_IssueTimelineItem_type"),
				 GropiusPackage.Literals.ISSUE_TIMELINE_ITEM__ISSUE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addCreatedByPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IssueTimelineItem_createdBy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IssueTimelineItem_createdBy_feature", "_UI_IssueTimelineItem_type"),
				 GropiusPackage.Literals.ISSUE_TIMELINE_ITEM__CREATED_BY,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addCreatedAtPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IssueTimelineItem_createdAt_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IssueTimelineItem_createdAt_feature", "_UI_IssueTimelineItem_type"),
				 GropiusPackage.Literals.ISSUE_TIMELINE_ITEM__CREATED_AT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_IssueComment_type") :
