...
public class IMSImpl extends MinimalEObjectImpl.Container implements IMS {
	...
	public Component getComponent() {
		if (component != null && component.eIsProxy()) {
			...
			if (component != oldComponent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GropiusPackage.IMS__COMPONENT, oldComponent, component));
			}
		}
		return component;
	}
	...
	public void setComponent(Component newComponent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GropiusPackage.IMS__COMPONENT, oldComponent, component));
	}
