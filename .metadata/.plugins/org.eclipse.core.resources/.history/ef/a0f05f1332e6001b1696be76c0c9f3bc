...
public interface DcPackage extends EPackage {
    ...
    /**
	 * Returns the meta object for the '{@link org.eclipse.dd.dc.Font#non_negative_size(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Non negative size</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
