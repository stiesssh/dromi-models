...
public class DocumentRootItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DiPackage.Literals.DOCUMENT_ROOT__BPMN_DIAGRAM);
			childrenFeatures.add(DiPackage.Literals.DOCUMENT_ROOT__BPMN_LABEL);
			childrenFeatures.add(DiPackage.Literals.DOCUMENT_ROOT__BPMN_LABEL_STYLE);
			childrenFeatures.add(DiPackage.Literals.DOCUMENT_ROOT__BPMN_PLANE);
		}
